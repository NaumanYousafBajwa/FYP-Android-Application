...
public class SwapableModelLayers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_swapable_model_layers);
        ...
        recyclerAdapter = new ModelLayersAdapter(moviesList);
